...
namespace MMR.Randomizer.GameObjects
{
    public enum Item
    {
        ...
        [LogicSetting(nameof(GameplaySettings.CloseCows), true)]
        SettingCloseCows,
        ...
        [LogicSetting(nameof(GameplaySettings.FreeScarecrow), true)]
        SettingFreeScarecrow,

        [LogicSetting(nameof(GameplaySettings.GiantMaskAnywhere), true)]
        SettingGiantMaskAnywhere,

        // [LogicSetting(nameof(GameplaySettings.SaferGlitches), true)]
        // SettingSaferGlitches,

        [LogicSetting(nameof(GameplaySettings.BombchuDrops), true)]
        SettingBombchuDrops,

        [LogicSetting(nameof(GameplaySettings.InstantTransform), true)]
        SettingInstantTransform,
        ...
        [LogicSetting(nameof(GameplaySettings.StrayFairyMode), StrayFairyMode.ChestsOnly)]
        SettingStrayFairyModeChestsOnly,

        [LogicSetting(nameof(GameplaySettings.StrayFairyMode), StrayFairyMode.ChestsOnly, false)]
        SettingNotStrayFairyModeChestsOnly,
        ...
        [LogicSetting(nameof(GameplaySettings.DamageMode), DamageMode.Double, false)]
        SettingNotDamageModeDouble,

        [LogicSetting(nameof(GameplaySettings.DamageMode), DamageMode.Quadruple, false)]
        SettingNotDamageModeQuadruple,

        [LogicSetting(nameof(GameplaySettings.DamageMode), DamageMode.OHKO, false)]
        SettingNotDamageModeOHKO,

        [LogicSetting(nameof(GameplaySettings.DamageMode), DamageMode.Doom, false)]
        SettingNotDamageModeDoom,

        [LogicSetting(nameof(GameplaySettings.DamageEffect), DamageEffect.Default)]
        SettingDamageEffectDefault,
        
        [LogicSetting(nameof(GameplaySettings.DamageEffect), DamageEffect.Fire, false)]
        SettingNotDamageEffectFire,

        [LogicSetting(nameof(GameplaySettings.DamageEffect), DamageEffect.Ice, false)]
        SettingNotDamageEffectIce,

        [LogicSetting(nameof(GameplaySettings.DamageEffect), DamageEffect.Shock, false)]
        SettingNotDamageEffectShock,

        [LogicSetting(nameof(GameplaySettings.DamageEffect), DamageEffect.Knockdown, false)]
        SettingNotDamageEffectKnockdown,

        [LogicSetting(nameof(GameplaySettings.DamageEffect), DamageEffect.Random, false)]
        SettingNotDamageEffectRandom,

        [LogicSetting(nameof(GameplaySettings.MovementMode), MovementMode.Default)]
        SettingMovementModeDefault,

        [LogicSetting(nameof(GameplaySettings.MovementMode), MovementMode.SuperLowGravity)]
        SettingMovementModeSuperLowGravity,

        [LogicSetting(nameof(GameplaySettings.MovementMode), MovementMode.LowGravity)]
        SettingMovementModeLowGravity,

        [LogicSetting(nameof(GameplaySettings.MovementMode), MovementMode.HighSpeed, false)]
        SettingNotMovementModeHighSpeed,

        [LogicSetting(nameof(GameplaySettings.MovementMode), MovementMode.HighGravity, false)]
        SettingNotMovementModeHighGravity,

        [LogicSetting(nameof(GameplaySettings.FloorType), FloorType.Default)]
        SettingFloorTypeDefault,

        [LogicSetting(nameof(GameplaySettings.FloorType), FloorType.Sand, false)]
        SettingNotFloorTypeSand,

        [LogicSetting(nameof(GameplaySettings.FloorType), FloorType.Ice, false)]
        SettingNotFloorTypeIce,

        [LogicSetting(nameof(GameplaySettings.FloorType), FloorType.Snow, false)]
        SettingNotFloorTypeSnow,

        [LogicSetting(nameof(GameplaySettings.FloorType), FloorType.Random, false)]
        SettingNotFloorTypeRandom,

        [LogicSetting(nameof(GameplaySettings.ClockSpeed), ClockSpeed.Default)]
        SettingClockSpeedDefault,

        [LogicSetting(nameof(GameplaySettings.ClockSpeed), ClockSpeed.Fast, false)]
        SettingNotClockSpeedFast,

        [LogicSetting(nameof(GameplaySettings.ClockSpeed), ClockSpeed.VeryFast, false)]
        SettingNotClockSpeedVeryFast,

        [LogicSetting(nameof(GameplaySettings.ClockSpeed), ClockSpeed.SuperFast, false)]
        SettingNotClockSpeedSuperFast,

        [LogicSetting(nameof(GameplaySettings.BlastMaskCooldown), BlastMaskCooldown.Instant)]
        SettingBlastMaskCooldownInstant,

        [LogicSetting(nameof(GameplaySettings.BlastMaskCooldown), BlastMaskCooldown.VeryShort)]
        SettingBlastMaskCooldownVeryShort,

        [LogicSetting(nameof(GameplaySettings.EnableSunsSong), true)]
        SettingEnableSunsSong,

        [LogicSetting(nameof(GameplaySettings.AllowFierceDeityAnywhere), true)]
        SettingAllowFierceDeityAnywhere,

        [LogicSetting(nameof(GameplaySettings.ByoAmmo), false)]
        SettingNotByoAmmo,

        [LogicSetting(nameof(GameplaySettings.DeathMoonCrash), false)]
        SettingNotDeathMoonCrash,

        [LogicSetting(nameof(GameplaySettings.HookshotAnySurface), true)]
        SettingHookshotAnySurface,

        [LogicSetting(nameof(GameplaySettings.Character), Character.AdultLink)]
        SettingCharacterAdultLink,

        [LogicSetting(nameof(GameplaySettings.Character), Character.AdultLink, false)]
        SettingNotCharacterAdultLink,

        [LogicSetting(nameof(GameplaySettings.FixEponaSword), false)]
        SettingNotFixEponaSword,

        // [LogicSetting(nameof(GameplaySettings.SpeedupBank), true)]
        // SettingSpeedupBank

        // [LogicSetting(nameof(GameplaySettings.SpeedupBank), false)]
