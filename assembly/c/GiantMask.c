...
void GiantMask_Handle(ActorPlayer* player, GlobalContext* globalCtx) {
    ...
    //if ((_transformationState != 0) && (_unk_1D22 != 0)) {
        ...
        // _unk_1D54 = Math_SinS(_cutsceneCounter * 1512) * unk_1D58;
        // Matrix_InsertZRotation_f(_unk_1D54, MTXMODE_APPLY);
        // Matrix_GetStateTranslationAndScaledY(1.0f, &_unk_1D3C);
        // z2_8016981C(globalCtx, _unk_1D22, &_unk_1D30, &_unk_1D24, &_unk_1D3C);
